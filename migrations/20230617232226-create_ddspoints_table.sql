...
CREATE TABLE IF NOT EXISTS `datapoints` (
  ...
  `BACnetObjectType` int(11) DEFAULT NULL,
  `BACnetObjectInstance` int(11) DEFAULT NULL,
  `BACnetObjectName` varchar(128) DEFAULT NULL,
  `BACnetDeviceInstance` int(11) DEFAULT NULL,
  `AddressType DHCP?` varchar(45) DEFAULT NULL,
